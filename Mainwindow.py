...
"border-radius: 40px;")
        ...
        self.textEdit.setGeometry(QtCore.QRect(470, 470, 104, 71))
...
"font-family: Consolas;")
        ...
        self.widget1.setGeometry(QtCore.QRect(760, 20, 121, 32))
